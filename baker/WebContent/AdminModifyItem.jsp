...
<h1 style=" font-size:500%;color:#003366;float:left;font-family:Brush Script MT;margin-top:10px;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Modify Items</b></h1>
...
<table align="left" >
<tr>
<td id="styling"><font size ="4"> Item Id :</td>

<td></font> <input type="text" placeholder ="Item Id" name="ItemId" required/><br></td>
</tr>
<tr>
<td id ="styling"><font size ="4"> Item Name :</td>

<td> </font> <input type="text" placeholder="Item Name" name ="ItemName" required/><br></td>
</tr>
<tr>
<td id ="styling"><font size = "4"> Quantity :</td>

<td>  </font><input type="number" placeholder="Quantity" name="Quantity" required ><br></td>
</tr>
<tr>
<td id ="styling"><font size = "4"> Price :</td>

<td> </font><input type="number" placeholder="Price"  name ="Price" required><br></td>
</tr>
<tr>
...
<td>
<input type="submit" class="button"  value="Modify" name="Operation">
</td>
<td>
